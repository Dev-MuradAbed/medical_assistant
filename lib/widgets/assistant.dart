    ...
    if (gendar == 'mael') {
      if (age >= 18 && age <= 25) {
        if (bmp >= 49 && bmp <= 55) {
          ...
          bpmText = AppLocalizations.of(context)!.error_try_again;
          ShowDilogNormal(
              context: context,
