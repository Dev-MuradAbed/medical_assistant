      ...
      children: List.generate(3, (index) =>  GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: selectChoose == index ? Color(0xff19A049) : Colors.transparent,
              width: 5,
            ),
            color: selectChoose == index ?   Colors.white:Color(0xff19A049),
          ...
          child: Text(
            ...
            style:  TextStyle(
              ...
              color:selectChoose== index ?  const Color(0xff184093) :Colors.white,
              fontSize: 30,
