...
class _Home_News_ScrrenState extends State<Home_News_Screen> with SingleTickerProviderStateMixin{
            ...
            if(snapshot.hasError){
              ...
              var sliderList=newList.articles !=null?
                  newList.articles!.length > 10?
                      ...
                      newList.articles!.take(newList.articles!.length).toList():[];
              //select article excepts top 10
              var contentList = newList.articles !=null?
                  newList.articles!.length>10?newList.articles!.getRange(11, newList.articles!.length-1).toList():
                      []:[];
                ...
                children: [
                  CarouselSlider(
                    ...
                    items: sliderList.map(( item) {
                      return Builder(builder: (context){return GestureDetector(
                        onTap: null,
                        child: Stack(
                          children: [
                            ClipRRect(
                            ...
                            Column(
                              ...
                              children: [
                                Container(
                                 ...
                                 child: Text('${item.title}',overflow: TextOverflow.ellipsis,style: TextStyle(
                                   color: Colors.white,
                                   fontSize: 16,
                  ...
                  Expanded(child: ListView.builder(
                    ...
                    itemBuilder: (context,index){
                      return GestureDetector(
                        onTap: (){
                          // Navigator.push(context, MaterialPageRoute(builder: (context)=>NewsDetail(contentList[index])));
                        },
                        child: ListTile(
                          leading: ClipRRect(
                            borderRadius: BorderRadius.circular(8),
                          ...
                          title: Text('${contentList[index].title}',overflow: TextOverflow.ellipsis,style: TextStyle(fontWeight: FontWeight.bold),),
                          subtitle: Text('${contentList[index].publishedAt}',style: TextStyle(fontSize: 12),),
